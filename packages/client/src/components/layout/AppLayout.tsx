...
import { LogOut, Shield, Settings, Users } from 'lucide-react';
                ...
                {activeTeam && teams.length > 1 && (
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                      <DropdownMenuLabel>Team wechseln</DropdownMenuLabel>
                ...
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <Button variant="ghost" className="gap-2">
                      {user.discordAvatar ? (
                        <img
                          src={`https://cdn.discordapp.com/avatars/${user.discordId}/${user.discordAvatar}.${user.discordAvatar.startsWith('a_') ? 'gif' : 'png'}?size=32`}
                          alt=""
