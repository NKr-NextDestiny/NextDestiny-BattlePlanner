      ...
      <div className="container mx-auto px-4 py-16 relative z-10">
        {!isAuthenticated ? (
          ...
          <div className="flex flex-col items-center justify-center min-h-[60vh] text-center">
            ...
            />
            <h1 className="text-3xl font-bold mb-4 font-heading text-foreground">{t('home.welcomeBack')}</h1>
            <p className="text-muted-foreground mb-8">{t('home.selectTeamPrompt')}</p>
            <Link
              to="/teams"
          ...
          <>
            <div className="text-center mb-12">
              <h1 className="text-3xl font-bold mb-2 font-heading text-foreground">{t('home.chooseGame')}</h1>
              <p className="text-muted-foreground">{t('home.chooseGameSub')}</p>
            </div>
            {isLoading ? (
                        ...
                        <Card className="hover:border-primary/40 transition-all cursor-pointer h-full border-primary/10 bg-card/80">
                          ...
                          <CardContent>
                            <div className="flex items-center text-primary text-sm font-medium tracking-wide">
                              {t('home.viewMaps')} <ArrowRight className="ml-1 h-4 w-4" />
                            </div>
                          </CardContent>
                        </Card>
                      </div>
