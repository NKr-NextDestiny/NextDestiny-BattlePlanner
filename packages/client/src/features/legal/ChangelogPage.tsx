...
const releases: Release[] = [
  ...
  },
  {
    ...
    changes: [
      ...
      { type: 'improvement', text: 'Create plan dialog integrated into game dashboard tab bar' },
      { type: 'fix', text: 'dev.bat aborts early with clear error message if Docker Desktop is not running' },
    ],
  },
  {
    version: '3.0.0',
    ...
    changes: [
      ...
      { type: 'feature', text: 'NextDestiny branding \u2014 new logo, orange primary (#f97316), deep dark background (#0a0a0f), Montserrat + Open Sans fonts' },
      { type: 'feature', text: 'Redesigned login page \u2014 centered NextDestiny logo with glitch/glow effects, Discord login button, German UI text' },
      { type: 'feature', text: 'Team switcher in navbar \u2014 quickly switch between teams without logging out' },
      { type: 'feature', text: 'Navbar logo with animated glow effect' },
      { type: 'feature', text: 'Multi-language support (i18next) \u2014 Deutsch, English, Piratensprache with browser language auto-detection' },
      ...
      { type: 'improvement', text: 'Help, FAQ, About, and Changelog now require login' },
      { type: 'improvement', text: 'FAQ and Help pages rewritten in German with Discord-auth-relevant content' },
      { type: 'improvement', text: 'Language switcher in navbar with localStorage persistence' },
      { type: 'improvement', text: 'Active team name always visible in navbar, even with only one team' },
      ...
      { type: 'fix', text: 'Discord avatar stored as hash instead of full URL (fixes broken avatar display for animated/GIF avatars)' },
